...
<div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
            <div>
                    <h3 class="text-center my-4">Data Subkategori</h3>       
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('subcategories.create') }}" class="btn btn-md btn-primary mb-3">Tambah Data</a>
                        <table class="table table-bordered table-hover table-striped  css-serial" >
                            ...
                            <tbody>
                              @forelse ($subcategories as $subcategory)
                                <tr>    
                                    <td></td>
                                    <td>{{ $subcategory->id_subkategori}}</td>
                                    <td>{{ $subcategory->nama_subkategori }}</td>
                                    <td>{{ $subcategory->deskripsi }}</td>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/subcategories/'.$subcategory->gambar) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td class="text-center">
                              ...
                              @empty
                                  <div class="alert alert-danger">
                                      Data Subkategori belum Tersedia.
                                  </div>
                              @endforelse
                            </tbody>
                          </table>  
